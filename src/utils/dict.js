...
export const DICT = {
    en: {
        ...
        aboutAttributeThree: "18 years of work in an international team",
        aboutAttributeFour: "Good work organization",
        aboutAttributeFive: "Commitment and creativity",
        aboutAttributeSix: "Experience in communicating in English",
        ...
        projectsProjectDescBeautyS: "A website of a beauty salon that is a business card of the company, but also an important tool for acquiring customers. It is clear and responsive, and presents the salon's services in an attractive and enticing way that encourages potential customers to use the services.",
    ...
    pl: {
        ...
        aboutAttributeThree: "18 lat pracy w międzynarodowym zespole",
        aboutAttributeFour: "Dobra organizacja pracy",
        aboutAttributeFive: "Zaangażowanie i kreatywność",
        aboutAttributeSix: "Doświadczenie w komunikacji w języku angielskim",
        ...
        projectsProjectTitleMW: "My Weather",
        projectsProjectDescMW: "Aplikacja webowa pokazująca prognozę pogody przy wykorzystaniu technologii front-endowych. Dzięki użyciu API pogodowego, użytkownik może otrzymać bieżące dane na temat pogody w danym miejscu na świecie. Interaktywny i gustowny interfejs pozwala na łatwe przeglądanie prognozy pogody na kilka dni do przodu, co czyni z aplikacji przydane i użyteczne narzędzie codziennego użytku.",
        ...
        projectsProjectTitleBeautyS: "Beauty Studio",
        projectsProjectDescBeautyS: "Strona internetowa salonu kosmetycznego będąca wizytówka firmy, ale także ważnym narzędziem do pozyskiwania klientów. Jest przejrzysta i responsywna oraz prezentuje usługi salonu w sposób atrakcyjny i zachęcający potencjalnych klientów do skorzystania z usług.",

        projectsProjectTitleTatarczuk: "Tatarczuk Usługi",
        projectsProjectDescTatarczuk: "Strona internetowa firmy wykonującej usługi hydrauliczne i serwis kotłów grzewczych. W sposób przejrzysty i harmonijny prezentuje ofertę zakładu. Odzwierciedla profesjonalizm i zaangażowanie w wykonywane usługi, co może zwiększyć zaufanie potencjalnych klientów do firmy.",
